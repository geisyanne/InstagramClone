...
import co.geisyanne.instagram.databinding.DialogCustomBinding
...
class CustomDialog(context: Context) : Dialog(context) {
    ...
    fun addButton(vararg texts: Int, listener: OnClickListener) {
    ...
    override fun show() {
        requestWindowFeature(Window.FEATURE_NO_TITLE) // CORRIGIR PARA API 21
        super.show()
